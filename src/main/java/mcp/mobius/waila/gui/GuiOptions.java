...
public abstract class GuiOptions extends Screen {
    ...
    public GuiOptions(Screen parent, TranslatableComponent title, Runnable saver, Runnable canceller) {
        super(title);
    ...
    public GuiOptions(Screen parent, TranslatableComponent title) {
