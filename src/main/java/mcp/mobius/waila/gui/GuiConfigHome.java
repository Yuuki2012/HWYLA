...
public class GuiConfigHome extends Screen
{
	...
	protected void init()
	{
		addButton(new ButtonWidget(width / 2 - 105, height / 2 - 10, 100, 20,
				I18n.translate("gui.waila.waila_settings", Waila.NAME), w ->
				{
					minecraft.openScreen(new GuiConfigWaila(GuiConfigHome.this));
				}));
		addButton(new ButtonWidget(width / 2 + 5, height / 2 - 10, 100, 20, I18n.translate("gui.waila.plugin_settings"),
				w ->
				{
