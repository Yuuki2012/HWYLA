...
public interface IPluginConfig
{
	 ...
	 *
	 * @param namespace
	 *            The namespace to get keys from
	...
	/**
	 * Gets a value from the config with the provided default returned if the key is
	 * not registered.
	 *
	 * @param key
	 *            The config key
	 * @param defaultValue
	 *            The default value
	 * @return The value returned from the config or the default value if none
	 *         exist.
	 */
