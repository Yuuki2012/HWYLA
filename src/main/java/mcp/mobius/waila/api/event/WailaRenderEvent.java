...
/**
 * The base event for rendering the Waila tooltip. This provides the opportunity
 * to do last minute changes to the tooltip.
 * <p>
...
public class WailaRenderEvent
{
	...
	/**
	 * This event is fired just before the Waila tooltip is rendered and right after
	 * setting up the GL state in
	 * {@link mcp.mobius.waila.overlay.OverlayRenderer#renderOverlay(mcp.mobius.waila.overlay.Tooltip)}
	 * <p>
	 * This event is cancelable. If this event is canceled, the tooltip will not
	 * render.
	 */
	...
	/**
	 * This event is fired just after the tooltip is rendered and right before the
	 * GL state is reset in
	 * {@link mcp.mobius.waila.overlay.OverlayRenderer#renderOverlay(mcp.mobius.waila.overlay.Tooltip)}
