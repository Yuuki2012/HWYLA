...
public class WailaClient implements ClientModInitializer
{
	...
	public void onInitializeClient()
	{
		...
		showOverlay = FabricKeyBinding.Builder.create(new Identifier(Waila.MODID, "show_overlay"), InputUtil.Type.KEYSYM, 321, Waila.NAME).build(); // Num
																														// 1
		toggleLiquid = FabricKeyBinding.Builder.create(new Identifier(Waila.MODID, "toggle_liquid"), InputUtil.Type.KEYSYM, 322, Waila.NAME).build(); // Num
																														// 2
